...
let sum = 0;
		...
		points.forEach((val, i) => {
            ...
            centrs.forEach((val, e) => {
                ...
                assignments.push(Math.round(sum));
               
               /* distance form the first, from second, from first, from second*/
                /*
                 {points[0]xerrorFromFirst, points[0]yErrorFromFirst},
                 {points[0]xErrorFromSecond, points[0]yErrorFromSecond}
                */
            });
            ...
            console.log(assignments.indexOf(Math.min.apply(null, assignments)))
